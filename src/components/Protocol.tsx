...
const protocols = [
  {
    ...
    desc: 'Visit our Georges Hall location for free water testing and expert advice on chemicals and equipment.',
    Animation: () => (
  ...
  },
  {
    ...
    desc: 'Our technicians come directly to your home or investment property to diagnose issues and recommend the right solutions.',
    Animation: () => (
      <svg className="w-full h-full text-aqua" viewBox="0 0 100 100" fill="none" stroke="currentColor" strokeWidth="2">
  ...
  {
    id: '03',
    title: 'Quality Repairs & Service',
    desc: 'From rapid pump repairs to ongoing maintenance, we ensure your pool stays healthy and crystal clear.',
    Animation: () => (
      <svg className="w-full h-full text-aqua" viewBox="0 0 100 100" fill="none" stroke="currentColor" strokeWidth="2">
...
export default function Protocol() {
  ...
  return (
    <section aria-label="Our 3-step pool care protocol" className="protocol-container relative bg-cream" ref={containerRef}>
