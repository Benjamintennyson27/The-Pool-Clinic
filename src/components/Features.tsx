      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="feature-card flex flex-col gap-6">
            <h3 className="text-2xl font-bold text-navy">Mobile Pool Service</h3>
            <p className="text-charcoal/70">Expert maintenance and cleaning directly at your home or investment property.</p>
            <ShufflerCard />
          </div>

          <div className="feature-card flex flex-col gap-6">
            <h3 className="text-2xl font-bold text-navy">Equipment Repairs</h3>
            <p className="text-charcoal/70">Reliable repair and installation for your pumps, filters, and chlorinators.</p>
            <TypewriterCard />
          </div>

          <div className="feature-card flex flex-col gap-6">
            <h3 className="text-2xl font-bold text-navy">Retail Showroom</h3>
            <p className="text-charcoal/70">Visit us in Georges Hall for direct replacement parts, top-tier chemicals, and free advice.</p>
            <SchedulerCard />
          </div>
        </div>
      </div>
